...
class TestCalculateDueDate(unittest.TestCase):
  ...
  def test_isWorkingHours(self):
    ...
    hour_1701 = datetime(2023, 6, 25, 17, 0, 1)
    ...
    self.assertFalse(IssueTrack.is_working_hours(hour_9))
    self.assertFalse(IssueTrack.is_working_hours(hour_10))
    self.assertFalse(IssueTrack.is_working_hours(hour_11))
    self.assertFalse(IssueTrack.is_working_hours(hour_12))
    self.assertFalse(IssueTrack.is_working_hours(hour_13))
    self.assertFalse(IssueTrack.is_working_hours(hour_14))
    self.assertFalse(IssueTrack.is_working_hours(hour_15))
    self.assertFalse(IssueTrack.is_working_hours(hour_16))
    self.assertFalse(IssueTrack.is_working_hours(hour_17))
    self.assertFalse(IssueTrack.is_working_hours(hour_1701))
